...
function StatTile({
  ...
  return (
    <Card asChild className="openWaterStatTile">
      <article>
        <p>{label}</p>
...
function DashboardReviewCard({
  ...
  return (
    <section className="openWaterSection openWaterReviewSection" aria-labelledby="up-next-title">
      ...
      <Card asChild className="openWaterReviewCard">
        <article>
...
function DashboardCollections({ dashboard }: { dashboard: DashboardHome }) {
  ...
  return (
    <section className="openWaterSection openWaterCollections" aria-labelledby="collections-title">
      ...
      <Card asChild className="openWaterDeckList">
        <div>
          {rows.map((row, index) => {
                ...
                {hasActiveSkills ? (
                  <>
                    ...
                    >
                      ...
                      >
                        {row.readyCount > 0
                          ? `${formatCount(row.readyCount)} ready`
                          : "Scheduled"}
                      </span>
                    </Badge>
                  </>
...
function ActivityHeatmap({
  ...
  return (
    <Card asChild className="openWaterSmallCard">
...
function Forecast({ dashboard, now }: { dashboard: DashboardHome; now: Date }) {
  ...
  return (
    <Card asChild className="openWaterSmallCard openWaterForecastCard">
