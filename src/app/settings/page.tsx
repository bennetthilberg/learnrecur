  ...
  return (
    <main className="skillShell settingsShell">
      ...
      <section className="skillPanel settingsPanel" aria-labelledby="practice-preferences-title">
        ...
        <div className="settingsPreferencesBody"><PracticePreferencesForm target={{scope:"user"}} preference={practicePreferences.practicePreference} mixedReview={practicePreferences.mixedReview} dailyNewSkillLimit={practicePreferences.dailyNewSkillLimit} practiceTimezone={practicePreferences.practiceTimezone} desiredRetention={practicePreferences.desiredRetention} practiceDayStartMinutes={practicePreferences.practiceDayStartMinutes}/></div>
      </section>
